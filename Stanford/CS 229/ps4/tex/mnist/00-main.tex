...
% \tnote{edited, the old version seems to be wrong}
...
% \tnote{change the equation to $e_{\ysi}^\top$}
...
% \tnote{changed the indexing system here, please double check}
